package cleancode.studycafe.tobewb.model.pass.seat;

import cleancode.studycafe.tobewb.model.pass.StudyCafePass;
...
public class StudyCafeSeatPass implements StudyCafePass {
	...
	public boolean isSameDurationType(StudyCafeLockerPass lockerPass) {
		return lockerPass.isSamePaasType(this.passType) && lockerPass.isSameDuration(this.duration);
	}
